...
class HCDevice:
    ...
    def reconnect(self):
        ...
        # ERROR: dishwasher Message Error: 404 /ci/authentication
        # self.get("/ci/authentication", version=2, data={"nonce": self.token})

        # ERROR: dishwasher Message Error: 404 /ci/info
        ...
        # dishwasher Message Error: 404 /ci/tzInfo
        # self.get("/ci/tzInfo")
        ...
        # ERROR: dishwasher Message Error: 400 /ro/values
        # self.get("/ro/values")
    ...
    def handle_message(self, buf):
        ...
        self.print("Message resource:", resource)
        values = {}
        ...
        if "code" in msg:
            ...
            # }
            self.print("Message Error:", msg["code"], msg.get("resource", ""))
